# Note: the code in this repo does not work anymore with newer versions of .NET MAUI, please refer to this one instead: https://github.com/jfversluis/MauiCustomizeControlSample
